                ...
                <div class="card-body">
                    <div class="author-box-left mb-5">
                        <img alt="Profile picture"
                             class="rounded-circle  author-box-picture img-fluid"
                             src="{{asset('http://127.0.0.1:8000/storage/finac/holder_weapons_picture/'.$holderWeapons->photo)}}"
                    ...
                    <div class="author-box-details author-box-name">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <p class="text-muted mb-0"><a
                                        href="{{ env('APP_URL') . 'storage/finac/identity_number/' .$holderWeapons->identity_number }}"
                                        target="_blank" class="btn btn-link download-btn">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <p class="text-muted mb-0"><a type="button"
                                                              href="{{ env('APP_URL') . 'storage/finac/buy_permission/' .$holderWeapons->buy_permission }}"
                                                              target="_blank" class="btn btn-link download-btn">
                                        <i class="fas fa-download"></i>
                        ...
                        <input type="hidden" id="codeFinac"
                               value="{{ \App\Http\Controllers\Helpers\HelpersFunction::getCodeFinacFromPermissionPortId($permissionsPort->id) }}">
                    </div>
                </div>
            </div>
        </div>
